...
class _DenseLayer(nn.Module):
    def __init__(self, in_channels, growth_rate):
        ...
        self.bottleneck = 4
        ### 1x1 conv i --> b*k
        self.conv_1 = CondenseConv(in_channels, self.bottleneck * growth_rate,
                                   kernel_size=1, groups=self.group_1x1)
        ### 3x3 conv b*k-->k
        self.conv_2 = Conv(self.bottleneck * growth_rate, growth_rate,
...
class CondenseNet(nn.Module):
    def __init__(self):
        ...
        self.progress = 0.0
        self.data = "ImageNet"
        if self.data in ['cifar10', 'cifar100']:
            self.init_stride = 1
            self.pool_size = 8
        else:
            self.init_stride = 2
        ...
        ### Linear layer
        num_classes = 1000
        self.classifier = CondenseLinear(self.num_features, num_classes,
                                         0.5)
        ### initialize
